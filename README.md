...
CrowdWiz Core is the CrowdWiz blockchain implementation and command-line interface.
The web wallet is [CrowdWiz UI](https://github.com/crowdwiz/crowdwiz-ui).

Visit [CrowdWiz.org](https://crowdwiz.org/) to learn about CrowdWiz and join the community at [CrowdWizTalk.org](https://crowdwiztalk.org/).
...
[wiki](https://github.com/crowdwiz/crowdwiz-core/wiki).
...
**Build Script:**
    ...
    git clone https://github.com/crowdwiz/crowdwiz-core.git
    cd crowdwiz-core
...
**Upgrade Script** (prepend to the Build Script above if you built a prior release):
    ...
    git remote set-url origin https://github.com/crowdwiz/crowdwiz-core.git
    git checkout master
...
**NOTE:** CrowdWiz requires a [Boost](http://www.boost.org/) version in the range [1.57 - 1.65.1]. Versions earlier than
...
**NOTE:** CrowdWiz requires a 64-bit operating system to build, and will not build on a 32-bit OS.

**NOTE:** CrowdWiz now supports Ubuntu 18.04 LTS

**NOTE:** CrowdWiz now supports OpenSSL 1.1.0
...
**IMPORTANT:** By default the witness node will start in reduced memory mode by using some of the commands detailed in [Memory reduction for nodes](https://github.com/crowdwiz/crowdwiz-core/wiki/Memory-reduction-for-nodes).
...
[here](https://github.com/crowdwiz/crowdwiz-core/blob/master/libraries/wallet/include/graphene/wallet/wallet.hpp).

Support
-------
Technical support is available in the [CrowdWizTalk technical support subforum](https://crowdwiztalk.org/index.php?board=45.0).

CrowdWiz Core bugs can be reported directly to the [issue tracker](https://github.com/crowdwiz/crowdwiz-core/issues).

CrowdWiz UI bugs should be reported to the [UI issue tracker](https://github.com/crowdwiz/crowdwiz-ui/issues)

Up to date online Doxygen documentation can be found at [Doxygen](https://crowdwiz.org/doxygen/hierarchy.html)
...
about API's for the [witness node](https://crowdwiz.github.io/doxygen/namespacegraphene_1_1app.html) and the
[wallet](https://crowdwiz.github.io/doxygen/classgraphene_1_1wallet_1_1wallet__api.html).
If you want information which is not available from an API, it might be available
from the [database](https://crowdwiz.github.io/doxygen/classgraphene_1_1chain_1_1database.html);
...
- What is the meaning of `a.b.c` numbers?
    ...
    [types.hpp](https://github.com/crowdwiz/crowdwiz-2/blob/crowdwiz/libraries/chain/include/graphene/chain/protocol/types.hpp).
...
- The answer to the previous question was really confusing.  Can you make it clearer?
    ...
    your asset's ID will be `1.3.29`.  Asset `0` is special (it's CWD, which is considered the "core asset").
...
License
-------
CrowdWiz Core is under the MIT license. See [LICENSE](https://github.com/crowdwiz/crowdwiz-core/blob/master/LICENSE.txt)
